...
public class CreatAL {
	...
	public static void main(String[] args) throws Exception {
        ...
        Map<Integer,List<RecommendationItem>>  result = ca.getRecomresult(recomuser,
        		datamap,similarity);
	...
	private List<Double> comPrecision(Map<Integer, List<RecommendationItem>>
	result,Map<Integer,Set<Integer>> testdata ) {
		int hit = 0;
		int resultsum = 0;
		int testdatasum = 0;
	...
	private Map<Integer, List<RecommendationItem>> getRecomresult(List<Integer> recomuser,Map<Integer,List<Integer>> 
	datamap,Map<Integer,Map<Integer,Double>> similarity) {
	...
	private HashMap<Integer, Double> getScore(List<Integer> recomitem, Map<Integer, Map<Integer, Double>> 
	similarity,List<Integer> useridlist) {
	...
	private  List<Integer> getRecomitem(int userid,Map<Integer, List<Integer>> datamap,
      ...
      for(Entry<Integer,Map<Integer,Integer>> e : entry){
	       ...
	       Map<Integer,Double> mm = new HashMap<Integer,Double>();
	   	   for(Entry<Integer,Integer> temp :ee){
	   		   ...
	   		   double sim =(double)commonnum/(double)Math.sqrt(
	   				   everyusernum.get(firstid)*everyusernum.get(secondid));  
	   		   mm.put(secondid, sim);
	   	   }
